...
; ============================================================================
	...
	.db PRG_BANKS			; PRG ROM size (32 × 16KB = 512KB)
	.db CHR_BANKS			; CHR ROM size (0 = CHR-RAM)
	.db $40			; Flags 6: Mapper low nibble (MMC3), battery
	.db $00			; Flags 7: Mapper high nibble
	.db $00			; PRG RAM size
	.db $00			; TV system
	.db $00			; Unused
...
game_mode_table:
	.dw update_title		; Mode 0: Title screen
	.dw update_field		; Mode 1: Field/overworld
	.dw update_battle		; Mode 2: Battle
	.dw update_menu		; Mode 3: Menu
	.dw update_dialog		; Mode 4: Dialog
...
; ============================================================================
	.segment "VECTORS"
	.dw nmi			; NMI vector ($fffa)
	.dw reset			; Reset vector ($fffc)
	.dw irq			; IRQ vector ($fffe)
